...
#else
        faad_imdct_asm(fb->mdct256, freq_in+0*nshort, transf_buf+2*nshort*0);
        faad_imdct_asm(fb->mdct256, freq_in+1*nshort, transf_buf+2*nshort*1);
        faad_imdct_asm(fb->mdct256, freq_in+2*nshort, transf_buf+2*nshort*2);
        faad_imdct_asm(fb->mdct256, freq_in+3*nshort, transf_buf+2*nshort*3);
        faad_imdct_asm(fb->mdct256, freq_in+4*nshort, transf_buf+2*nshort*4);
        faad_imdct_asm(fb->mdct256, freq_in+5*nshort, transf_buf+2*nshort*5);
        faad_imdct_asm(fb->mdct256, freq_in+6*nshort, transf_buf+2*nshort*6);
        faad_imdct_asm(fb->mdct256, freq_in+7*nshort, transf_buf+2*nshort*7);
#endif
